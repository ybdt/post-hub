0x01 Go实现自动化连接ssh并反弹shell  
文章地址：https://ybdt.me/2024/05/07/自动化连接ssh并反弹shell/  
代码仓库：Go实现自动化连接ssh并反弹shell  
代码仓库：Go实现自动化连接ssh并反弹shell且带有回显  

0x02 DCOM内网横向探究  
文章地址：https://ybdt.me/2026/01/12/DCOM内网横向探究/  
代码仓库：DCOM横向移动  

0x03 利用控制面板COM对象实现内网横向移动的新型DCOM攻击技术  
文章地址：https://ybdt.me/2026/01/13/利用控制面板COM对象实现内网横向移动的新型DCOM攻击技术/  
代码仓库：新型DCOM内网横向之控制面板  
